...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "account" | "session" | "user" | "verificationToken" | "gameScore"
    ...
    model: {
      ...
      GameScore: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.GameScoreFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.GameScoreAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface GameScoreDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more GameScores that matches the filter.
     * @param {GameScoreFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const gameScore = await prisma.gameScore.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: GameScoreFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a GameScore.
     * @param {GameScoreAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const gameScore = await prisma.gameScore.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: GameScoreAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * GameScore findRaw
   */
  export type GameScoreFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * GameScore aggregateRaw
   */
  export type GameScoreAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
